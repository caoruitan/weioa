...
<html>
	...
	<body>
		...
		<div class="m-layout">
			...
			<c:if test='${workOrder.workOrderStatus ne "APPROVAL"}'>
		...
		<div class="m-footer">
			<c:if test='${workOrder.workOrderStatus eq "APPROVAL" && workOrder.workOrderApprovalStatus eq "APPROVING"}'>
				<span class="m-btn w-60"><a href="${basePath}/workorder/leader/toApprovalWorkOrder.htm?workOrderId=${workOrder.workOrderId}" class="bg-blue">审批</a></span>
				<span class="m-btn w-40"><a href="${basePath}/workorder/leader/workOrderList.htm" class="bg-gray">返回工作台</a></span>
			</c:if>
			<c:if test='${workOrder.workOrderStatus eq "APPROVAL" && workOrder.workOrderApprovalStatus eq "UNPASS"}'>
				<span class="m-btn w-100"><a href="${basePath}/workorder/leader/workOrderList.htm" class="bg-gray">返回工作台</a></span>
			</c:if>
			...
			<c:if test='${workOrder.workOrderStatus eq "REPORT_SUBMIT"}'>
				<span class="m-btn w-100"><a href="${basePath}/workorder/leader/workOrderList.htm" class="bg-gray">返回工作台</a></span>
			</c:if>
