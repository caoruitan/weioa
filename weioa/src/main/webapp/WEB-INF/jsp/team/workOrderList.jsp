...
<html>
	...
	<body>
		...
		<div class="m-layout">
			...
			<div class="m-tabs">
				<a href="#" class="active" style="width:33.333333%">进行中的工作单</a>
				<a href="#" style="width:33.333333%">已完成的工作单</a>
				<a href="#" style="width:33.333333%">抄送的工作单</a>
			</div>
			...
			<div class="m-tabs-page m-tabs-page-actived">
				<c:forEach items="${workOrderList}" var="workOrder">
					<c:if test='${workOrder.workOrderStatus ne "OVER"}'>
						<a href="${basePath}/workorder/team/workOrderDetail.htm?workOrderId=${workOrder.workOrderId}">
							<div class="m-box">
								<li>
			...
			<div class="m-tabs-page">
				<c:forEach items="${ccWorkOrderList}" var="obj">
					<a href="${basePath}/workorder/team/ccWorkOrderDetail.htm?carbonCopyId=${obj[1].carbonCopyId}">
						<div class="m-box">
							<li>
								<p><img src="${basePath}/res/images/ydbh.png" />工作单号</p>
								<p>${obj[0].workOrderId}</p>
							</li>
							<li>
								<p>申请国家队</p>
								<p>${obj[0].workForTeam}</p>
							</li>
							<li>
								<p>下队地点</p>
								<p>${obj[0].workSpace}</p>
							...
							<li>
								<p>申请人</p>
								<p>${obj[0].workOrderCreatorName}</p>
							</li>
							<li>
								<p class="red">${statusNames[obj[0].workOrderStatus]}</p>
								<p><span class="m-right"></span></p>
							</li>
						</div>
					</a>
